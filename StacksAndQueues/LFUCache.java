...
class LFUCache {
   ...
   private void updateFreqListMap(Node node) {
       ...
       // Update the frequency list hashmap i.e delete the node with the cnt to
       // move it to next higher frequency list
       freqListMap.get(node.cnt).removeNode(node);
       
       // If node was the only node having its frequency
       // And because we deleted it, the frequency list is empty
       if (node.cnt == minFreq && 
           freqListMap.get(node.cnt).size == 0) {
           // Update the minimum frequency. E.g if minFreq was 2
           // we deleted the only node with freq 2, now minFreq should be 3
           minFreq++;
       }
       
       // Creating a dummy list for next higher frequency
       FreqList nextHigherFreqList = new FreqList();
   ...
   public void put(int key, int value) {
       ...
       if (keyNode.containsKey(key)) {
           ...
           if (curSize == maxSizeCache) {
               ...
               FreqList list = freqListMap.get(minFreq);
               // We remove the node which is the previous of tail
           ...
           // Create a dummy list
           FreqList listFreq = new FreqList();
   ...
   public static void main(String[] args) {
       ...
       cache.put(1, 1);
       cache.put(2, 2);
       System.out.println("The value of key 1 is: "+cache.get(1) + " ");
       cache.put(3, 3);
       System.out.println("The value of key 2 is: "+cache.get(2) + " ");
       System.out.println("The value of key 3 is: "+cache.get(3) + " ");
       cache.put(4, 4);
       System.out.println("The value of key 1 is: "+  cache.get(1) + " ");
       System.out.println("The value of key 3 is: "+cache.get(3) + " ");
       System.out.println("The value of key 4 is: "+cache.get(4) + " ");
   }
}
